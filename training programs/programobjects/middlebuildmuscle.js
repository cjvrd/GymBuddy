      ...
      days: [
        {
          dayNumber: 1,
          exercises: [
            { name: "Bench Press", sets: 3, reps: "AMRAP" },
            { name: "Shoulder Press", sets: 3, reps: "AMRAP" },
            { name: "Tricep Extension", sets: 3, reps: "AMRAP" },
          ],
        },
        {
          dayNumber: 2,
          exercises: [
            { name: "Barbell Row", sets: 3, reps: "AMRAP" },
            { name: "Pull Up", sets: 3, reps: "AMRAP" },
            { name: "Bicep Curl", sets: 3, reps: "AMRAP" },
          ],
        },
        {
          dayNumber: 3,
          exercises: [
            { name: "Squat", sets: 3, reps: "AMRAP" },
            { name: "Romanian Deadlift", sets: 3, reps: "AMRAP" },
            { name: "Calf Raise", sets: 3, reps: "AMRAP" },
          ],
        },
      ],
    },
